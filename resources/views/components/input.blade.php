...
<div class="flex flex-col gap-1.5">
    ...
    <input
        ...
        {{ $attributes->merge([
            'class' => 'w-full px-4 py-2.5 rounded-xl border text-sm text-[#1F2937] placeholder-[#6B7280] transition-colors focus:outline-none focus:ring-2 focus:ring-[#6B21A8] focus:border-transparent '
