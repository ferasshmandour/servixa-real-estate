...
@foreach (['success', 'error', 'warning', 'info'] as $type)
    @if (session($type))
        ...
        <div
            ...
            class="mb-4 flex items-start gap-3 px-4 py-3 rounded-xl {{ $a['bg'] }} {{ $a['text'] }}"
            role="alert"
        >
            ...
            <button type="button" x-on:click="show = false" class="opacity-60 hover:opacity-100 transition-opacity">
